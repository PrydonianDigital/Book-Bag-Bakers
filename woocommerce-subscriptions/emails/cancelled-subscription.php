...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #111;" border="1" bordercolor="#eee">
	<thead>
		<tr>
			<th scope="col" style="text-align:left; border: 1px solid #111;"><?php _e( 'Order', 'woocommerce-subscriptions' ); ?></th>
			...
			<th scope="col" style="text-align:left; border: 1px solid #111;"><?php _e( 'Last Payment', 'woocommerce-subscriptions' ); ?></th>
			<th scope="col" style="text-align:left; border: 1px solid #111;"><?php _e( 'End of Prepaid Term', 'woocommerce-subscriptions' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<tr class="order">
			<td width="1%" style="text-align:left; border: 1px solid #111; vertical-align:middle;">
				<?php echo $order->get_order_number(); ?>
			</td>
			<td style="text-align:left; border: 1px solid #111; vertical-align:middle;">
				<?php echo $item_name; ?>
			</td>
			<td style="text-align:left; border: 1px solid #111; vertical-align:middle;">
