...
<p><?php printf( __( "Hi there. Your subscription renewal order on %s has been completed. Your order details are shown below for your reference:", 'woocommerce-subscriptions' ), get_option( 'blogname' ) ); ?></p>
