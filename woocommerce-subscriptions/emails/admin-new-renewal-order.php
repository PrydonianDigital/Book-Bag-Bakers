...
<p><?php printf( __( 'You have received a subscription renewal order from %s. Their order is as follows:', 'woocommerce-subscriptions' ), $order->billing_first_name . ' ' . $order->billing_last_name ); ?></p>
